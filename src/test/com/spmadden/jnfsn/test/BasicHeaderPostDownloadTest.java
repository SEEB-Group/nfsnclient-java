 ...
 *
 */
public class BasicHeaderPostDownloadTest {

	private static final Logger LOG = Logger.getLogger(BasicHeaderPostDownloadTest.class);
	...
	public static void main(String[] args) throws IOException {
		...
		final InputStream is = BasicHeaderPostDownloadTest.class.getResourceAsStream("/testprops.properties");
		...
		final String domain = p.getProperty("domain");
		final String url = "/dns/"+domain+"/listRRs";
		...
		HTTPConnection conn = new HTTPConnection(fullurl, RequestMethod.POST, gen);
		conn.addFormField("type", "A");
